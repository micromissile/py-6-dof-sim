...
#
#----------------------------------------------------------------------------------
from vehicle_models.rocket import rockets

# Define vehicle model
vmod = rockets.RocketDev()
...
# save_data = 'on'
save_data = 'off'
save_dir  = './jobs/S_1_5_1_Sphere_Verification/output_data/Atmos_01_Python_6DOF.npy'
...
save_euler_angle_plot_dir = './jobs/S_1_5_1_Sphere_Verification/plots/' + name_euler_angle_plot

save_position_plot = 'on'
#save_position_plot = 'off'
name_position_plot = 'S1p5_' + vmod["short_name"] + '_Position_Plot.png'
save_position_plot_dir = './jobs/S_1_5_1_Sphere_Verification/plots/' + name_position_plot

save_air_data_plot = 'on'
#save_air_data_plot = 'off'
name_air_data_plot = 'S1p5_' + vmod["short_name"] + '_Air_Data_Plot.png'
save_air_data_plot_dir = './jobs/S_1_5_1_Sphere_Verification/plots/' + name_air_data_plot
