...
if __name__ == '__main__':  # NOTE: This is REQUIRED on Windows!
    ...
    data_pysim  = np.load('./case_studies/verification/Atmos_01/Atmos_01_Python_6DOF.npy')
    ...
    while True:
        ...
        # Pyramids
        #lat_rad_parent  = 29.979167*0.01745329 # (converts deg to rad)
        #long_rad_parent = 31.134167*0.01745329
